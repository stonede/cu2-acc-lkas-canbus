...
A separate wire between radar and ACC unit measures approximately 8.5 V in previous investigation. It may be LIN-like or another proprietary single-wire physical layer. The following remain open:
